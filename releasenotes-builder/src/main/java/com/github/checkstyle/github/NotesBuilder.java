...
public final class NotesBuilder {
    ...
    public static Result buildResult(String localRepoPath, String authToken, String remoteRepoPath,
        ...
        for (RevCommit commit : commitsForRelease) {
            ...
            result = buildResultWithLabel(remoteRepoPath, remoteRepo, commitsForRelease,
     ...
     *
     * @param remoteRepoPath path to remote git repository.
     * @param remoteRepo remote repository to check label
     * @param commitsForRelease commits to check for release.
     * @param commit Commit pushed to remote repository.
     * @param commitMessage message of commit provided.
     * @return a map which represents release notes.
     * @throws IOException if an I/O error occurs.
     * @throws GitAPIException if an error occurs when accessing Git API.
     */
    public static Result buildResultWithLabel(String remoteRepoPath,
